...
def parse_args():
    ...
    # dir config
    parser.add_argument('--exp_dir', type=str, default='./exp/DoDNet')
    parser.add_argument('--data_dir', type=str, default='./dataset/word3d')
    parser.add_argument('--workspace', type=str, default='./exp/DoDNet/checkpoint')
    # GPU config
...
def main():
    ...
    #  init model
    model = UNet3D(weight_std = args.weight_std).cuda()
