...
def parse_args():
    ...
    # dir config
    parser.add_argument('--exp_dir', type=str, default='./exp/WORD/LeafDice')
    parser.add_argument('--data_dir', type=str, default='./datasets/WORD_LeafDice')
    parser.add_argument('--workspace', type=str, default='./exp/WORD/LeafDice/checkpoint')
    # GPU config
...
def train(model, train_loader, val_loader, writer, args):
    ...
    criterion = LeafDiceLoss(args.num_classes)
...
def main():
    ...
    composed_transforms_tr = transforms.Compose([
        tr.LabeledClass(args.num_classes + 1),
