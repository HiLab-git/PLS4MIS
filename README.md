...
|2024-03|X. Chen and Y. Fan|Versatile medical image segmentation learned from multi-source datasets via model self-disambiguation|None|[CVPR2024]([https://openreview.net/forum?id=sfjgmuvLS7](https://openaccess.thecvf.com/content/CVPR2024/html/Chen_Versatile_Medical_Image_Segmentation_Learned_from_Multi-Source_Datasets_via_Model_CVPR_2024_paper.html))|
